...
function WebAffiliatesTab() {
  ...
  const td = { padding: '10px 12px', fontSize: 12, color: '#1a2332', borderBottom: '1px solid #e2e8f0' }

  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <h2 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: '#1a2332' }}>🤝 Affiliates (SaaS)</h2>
      </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {conversions.length === 0 && (
                    <tr><td colSpan={9} style={{ ...td, textAlign: 'center', color: '#94a3b8', padding: '32px' }}>Không có dữ liệu</td></tr>
                  )}
                  {conversions.map(c => (
        ...
        loading ? <Spinner /> : (
          <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #e2e8f0', overflow: 'hidden' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {affiliates.length === 0 && (
                  <tr><td colSpan={9} style={{ ...td, textAlign: 'center', color: '#94a3b8', padding: '32px' }}>Chưa có affiliate nào</td></tr>
                )}
                {affiliates.map(a => (
                  <tr key={a.id}>
...
export default function Dashboard() {
  ...
  const tabContent = {
    ...
    'web_affiliates': <WebAffiliatesTab />,
