      ...
      <div className="page-wrap">
        <div className="page-header">
          ...
          <div>
            ...
            <p>Thiết lập tự động điều kiện kiểm soát quảng cáo</p>
          </div>
        </div>
        ...
        {!fbConnected ? (
          <div className="fb-required">
            ...
            <div className="fbr-desc">Tính năng Tự động Set QC yêu cầu kết nối tài khoản Facebook Ads.</div>
          ...
          <div className="coming-soon">
            ...
            <div className="cs-desc">Tính năng Tự động Set QC đang được xây dựng và sẽ ra mắt sớm.</div>
          </div>
        )}
      </div>
