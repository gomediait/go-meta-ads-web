...
export const translations = {
  ...
  vi: {
    ...
    hero: {
      ...
      trust: ['Cài đặt dưới 3 phút', 'Dữ liệu bảo mật 100% local', 'Không cần kỹ thuật', 'Hỗ trợ Zalo & Messenger'],
    },
  ...
  en: {
    ...
    hero: {
      ...
      trust: ['Setup in under 3 min', '100% local data security', 'No tech skills needed', 'Zalo & Messenger support'],
    },
