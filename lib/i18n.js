...
export const translations = {
  ...
  vi: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Có. Gói dùng thử 1 ngày miễn phí cho trải nghiệm đầy đủ tính năng gói Agency. Sau 1 ngày bạn chọn gói phù hợp hoặc không cần tiếp tục — không tự động trừ tiền.',
        },
        {
    ...
    cta: {
      ...
      subtitle: 'Dùng thử 1 ngày miễn phí — không cần thẻ tín dụng, không cần cài đặt phức tạp, hỗ trợ Zalo trực tiếp trong 5 phút.',
      cta1:     'Dùng miễn phí 1 ngày',
      cta2:     'Xem bảng giá →',
    ...
    pages: {
      'tai-xuong': {
        ...
        cta:      'Tải xuống ngay (miễn phí 1 ngày)',
      },
      'quan-ly': {
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Yes. The 1-day free trial gives you full access to all Agency-level features. After 1 day you choose a plan or stop — no automatic charges.',
        },
        {
    ...
    cta: {
      ...
      subtitle: 'Try free for 1 day — no credit card, no complex setup, Zalo support within 5 minutes.',
      cta1:     'Try Free for 1 Day',
      cta2:     'View Pricing →',
